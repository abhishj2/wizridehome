...
@Component({
  selector: 'app-wizzrideinternationalholiday',
  standalone: true,
  imports: [],
  templateUrl: './wizzrideinternationalholiday.component.html',
  styleUrl: './wizzrideinternationalholiday.component.css'
})
export class WizzrideinternationalholidayComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    // Set canonical URL
    this.seoService.setCanonicalURL('https://wizzride.com/ourservices/holidaystours/Wizzride-International-Holiday-Planner/');
    
    // ✅ SEO Metadata
    this.titleService.setTitle("Explore the World with Wizzride International Packages");
    this.metaService.updateTag({
      name: 'description',
      content: "Explore top destinations like Japan, South Korea, Singapore, Dubai, and Malaysia with Wizzride's luxury international packages."
    });
    this.metaService.updateTag({
      name: 'title',
      content: "Explore the World with Wizzride International Packages"
    });

    // Open Graph Tags
    this.metaService.updateTag({ property: 'og:title', content: "Explore the World with Wizzride International Packages" });
    this.metaService.updateTag({ property: 'og:description', content: "Explore top destinations like Japan, South Korea, Singapore, Dubai, and Malaysia with Wizzride's luxury international packages." });
    this.metaService.updateTag({ property: 'og:type', content: 'website' });
    this.metaService.updateTag({ property: 'og:url', content: 'https://wizzride.com/ourservices/holidaystours/Wizzride-International-Holiday-Planner/' });
    ...
    this.metaService.updateTag({ name: 'twitter:title', content: "Explore the World with Wizzride International Packages" });
    this.metaService.updateTag({ name: 'twitter:description', content: "Explore top destinations like Japan, South Korea, Singapore, Dubai, and Malaysia with Wizzride's luxury international packages." });
    ...
    this.addJsonLd({
      ...
      "itemListElement": [{
        ...
        },
        {
          "@type": "ListItem",
          "position": 4,
          "name": "International Holiday Planner",
          "item": {
            "@type": "Service",
            "@id": "https://www.wizzride.com/ourservices/holidaystours/Wizzride-International-Holiday-Planner"
          }
        }
      ]
    });
  ...
  private initFormSubmission(): void {
    ...
    if (contactForm) {
      this.renderer.listen(contactForm, 'submit', (e: Event) => {
        ...
        // Log to console
        console.log('=== International Tour Enquiry Form Submission ===');
        console.log('Form Data:', formDataObject);
        console.log('Timestamp:', new Date().toLocaleString());
        console.log('==========================================');
        
        // Create readable alert message
        let alertMessage = 'International Tour Enquiry Submitted!\n\n';
        alertMessage += `Full Name: ${formDataObject['fullName']}\n`;
        alertMessage += `Contact Number: ${formDataObject['contactNumber']}\n`;
        alertMessage += `Email: ${formDataObject['email']}\n`;
        alertMessage += `Location: ${formDataObject['location']}\n`;
        alertMessage += `Message: ${formDataObject['message']}\n\n`;
        alertMessage += 'Thank you for your enquiry! Our travel experts will contact you soon to help plan your perfect international journey.';
    ...
    modal.innerHTML = `
      ...
      ">
          ...
          <p style="color: #64748b; margin-bottom: 2rem; line-height: 1.6; font-size: 1.1rem;">
              Contact our travel experts to create your perfect international travel experience. We'll craft a personalized itinerary just for you!
          </p>
