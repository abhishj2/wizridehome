...
export class HolidaytoursComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.metaService.updateTag({ property: 'og:image', content: 'https://wizztest.com/assets/images/holidayhero.jpeg' });
    ...
    this.metaService.updateTag({ name: 'twitter:image', content: 'https://wizztest.com/assets/images/holidayhero.jpeg' });
...
this.addJsonLd({
  ...
  onSubmit(): void {
    ...
    this.http.post('https://cms.wizztest.com/wp-json/wp/v2/holiday_enquiries', submissionData)
      .subscribe({
        next: (response) => {
