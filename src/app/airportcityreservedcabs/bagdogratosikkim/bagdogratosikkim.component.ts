...
@Component({
  selector: 'app-bagdogratosikkim',
  standalone: true,
  imports: [],
  templateUrl: './bagdogratosikkim.component.html',
  styleUrl: './bagdogratosikkim.component.css'
})
export class BagdogratosikkimComponent  implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    // Set canonical URL
    this.seoService.setCanonicalURL('https://wizzride.com/ourservices/Luxury-Reserved-Cabs/Bagdogra_Airport_To_Sikkim_Reserved_Cab_Service');
    
    // ✅ SEO Metadata
    this.titleService.setTitle("Reserved Cab from Bagdogra Airport to Sikkim | Wizzride");
    this.metaService.updateTag({
      name: 'description',
      content: "Book a reserved cab from Bagdogra Airport to Sikkim. Choose from SUVs, sedans, and luxury cars for an affordable journey to Gangtok, Pelling, Lachung."
    });
    this.metaService.updateTag({
      name: 'title',
      content: "Reserved Cab from Bagdogra Airport to Sikkim | Wizzride"
    });

    // Open Graph Tags
    this.metaService.updateTag({ property: 'og:title', content: 'Reserved Cab from Bagdogra Airport to Sikkim | Wizzride' });
    ...
    this.addJsonLd({
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Reserved Cab from Bagdogra Airport to Sikkim ",
          "item": "https://wizzride.com/ourservices/Luxury-Reserved-Cabs/Bagdogra_Airport_To_Sikkim_Reserved_Cab_Service"
        }
      ]
    });
  }
