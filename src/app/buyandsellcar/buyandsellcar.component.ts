...
export class BuyandsellcarComponent implements OnInit, OnDestroy {
  ...
  fetchTestimonials(): void {
    ...
    this.http.get<Testimonial[]>('https://cms.wizztest.com/wp-json/wp/v2/vehicle_testimonials?_embed&per_page=4&orderby=date&order=desc')
      .subscribe({
        next: (data) => {
  ...
  fetchVehicleCategories(): void {
    ...
    this.http.get<VehicleCategory[]>('https://cms.wizztest.com/wp-json/wp/v2/vehicle_category')
      .subscribe({
        next: (data) => {
  ...
  fetchVehicleBrands(): void {
    ...
    this.http.get<VehicleBrand[]>('https://cms.wizztest.com/wp-json/wp/v2/vehicle_brand')
      .subscribe({
        next: (data) => {
  ...
  fetchFeaturedVehicles(): void {
    ...
    this.http.get<Vehicle[]>('https://cms.wizztest.com/wp-json/wp/v2/buy_sell_cars?status=publish&per_page=100&_embed')
      .subscribe({
        next: (data) => {
