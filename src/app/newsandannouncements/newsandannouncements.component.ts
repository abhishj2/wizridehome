...
export class NewsandannouncementsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  fetchBlogPosts(): void {
    ...
    this.http.get<BlogPost[]>('https://wizztest.com/wp-json/wp/v2/posts?_embed&per_page=5')
      .subscribe({
        next: (data) => {
          this.blogPosts = data;
  ...
  fetchPressReleases(): void {
    ...
    this.http.get<PressRelease[]>('https://wizztest.com/wp-json/wp/v2/press_releases')
      .subscribe({
        next: (data) => {
  ...
  fetchFeaturedOffers(): void {
    ...
    this.http.get<FeaturedOffer[]>('https://wizztest.com/wp-json/wp/v2/featured_offers?_embed')
      .subscribe({
        next: (data) => {
  ...
  fetchAnnouncements(): void {
    ...
    this.http.get<Announcement[]>('https://wizztest.com/wp-json/wp/v2/announcements')
      .subscribe({
        next: (data) => {
