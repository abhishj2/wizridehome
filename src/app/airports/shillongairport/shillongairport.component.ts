...
export class ShillongairportComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private readonly schemaIds = ['shillong-faq', 'shillong-breadcrumb'];
  ...
  ngOnInit(): void {
    ...
    this.metaService.updateTag({ property: 'og:url', content: 'https://wizzride.com/airports/shillongairport' });
