...
export class SavasagarComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private readonly schemaIds = ['sivasagar-faq', 'sivasagar-breadcrumb'];
  ...
  ngOnInit(): void {
    ...
    this.metaService.updateTag({ property: 'og:image', content: 'https://wizztest.com/assets/images/destinations/sivasagarboaat.jpeg' });
    ...
    this.metaService.updateTag({ name: 'twitter:image', content: 'https://wizztest.com/assets/images/destinations/sivasagarboaat.jpeg' });
