...
export class KohimaComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private readonly schemaIds = ['kohima-faq', 'kohima-breadcrumb'];
  ...
  ngOnInit(): void {
    ...
    this.metaService.updateTag({ property: 'og:image', content: 'https://wizztest.com/assets/images/destinations/kohima.3fb979cb315ab2bd.jpg' });
    ...
    this.metaService.updateTag({ name: 'twitter:image', content: 'https://wizztest.com/assets/images/destinations/kohima.3fb979cb315ab2bd.jpg' });
