...
export class DzukouvalleyComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private readonly schemaIds = ['dzukou-faq', 'dzukou-breadcrumb'];
  ...
  ngOnInit(): void {
    ...
    this.metaService.updateTag({ property: 'og:image', content: 'https://wizztest.com/assets/images/destinations/dzukou-scenic-view.57aad113f3e15734.jpeg' });
    ...
    this.metaService.updateTag({ name: 'twitter:image', content: 'https://wizztest.com/assets/images/destinations/dzukou-scenic-view.57aad113f3e15734.jpeg' });
