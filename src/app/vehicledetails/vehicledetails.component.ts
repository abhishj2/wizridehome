...
export class VehicledetailsComponent implements OnInit, OnDestroy {
  ...
  fetchVehicleDetails(): void {
    ...
    this.http.get<Vehicle[]>(`https://wizztest.com/wp-json/wp/v2/buy_sell_cars?include=${this.vehicleId}`)
      .subscribe({
        next: (data) => {
  ...
  onEnquirySubmit(): void {
    ...
    this.http.post('https://wizztest.com/wp-json/wp/v2/vehicle_enquiries', enquiryData)
      .subscribe({
        next: (response) => {
